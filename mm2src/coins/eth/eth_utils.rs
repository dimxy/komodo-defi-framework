...
#[inline]
pub fn u256_from_coins_mm_number(mm_number: &MmNumber, decimals: u8) -> NumConversResult<U256> {
    u256_from_big_decimal(&mm_number.to_decimal(), decimals)
}

#[inline]
#[allow(unused)]
pub fn u256_to_coins_mm_number(u256: U256, decimals: u8) -> NumConversResult<MmNumber> {
