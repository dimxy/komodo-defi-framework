...
mod pubkey;
pub use pubkey::{ExtractExtendedPubkey, HDXPubExtractor, RpcTaskXPubExtractor, UniExtendedPublicKey};
    ...
    HDAddress: HDAddressOps + Send,
{
    ...
    pub extended_pubkey: UniExtendedPublicKey,
    ...
    HDAddress: HDAddressOps + Clone + Send,
{
    ...
    fn extended_pubkey(&self) -> &UniExtendedPublicKey { &self.extended_pubkey }
}
    ...
    HDAddress: HDAddressOps + Send,
{
        ...
        Self: Sized,
    {
        ...
        let extended_pubkey = UniExtendedPublicKey::from_str(&account_info.account_xpub)
...
where
    Coin: ExtractExtendedPubkey + Sync,
