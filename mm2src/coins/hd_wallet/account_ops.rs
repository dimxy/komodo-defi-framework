use super::{HDAddressOps, HDAddressesCache, InvalidBip44ChainError, UniExtendedPublicKey};
...
pub trait HDAccountOps {
    ...
    fn new(
        account_id: u32,
        account_extended_pubkey: UniExtendedPublicKey,
    ...
    fn extended_pubkey(&self) -> &UniExtendedPublicKey;
}
