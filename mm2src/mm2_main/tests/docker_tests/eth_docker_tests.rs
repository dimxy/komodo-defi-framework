...
use coins::eth::{
    addr_from_raw_pubkey, checksum_address, eth_coin_from_conf_and_request, ChainSpec, EthCoin, EthCoinType,
...
use mm2_test_helpers::for_tests::{
    account_balance, active_swaps, coins_needed_for_kickstart, disable_coin, enable_erc20_token_v2,
